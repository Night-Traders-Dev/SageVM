...
- `exception_try_edge.sage`: Tests `try-catch` blocks with clean execution (`OP_END_TRY`), raising primitive values (`raise 404`, `raise false`, `raise nil`), and re-raising array exceptions across nested blocks.
