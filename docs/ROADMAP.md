...
- ✅ **GPU Hot-Paths**: Full implementation of `BC_OP_GPU_*` opcodes for Vulkan/OpenGL acceleration via host delegation.
- ✅ **Networking**: Implementation of `net`, `socket`, and `http` modules via host delegation bridge.
