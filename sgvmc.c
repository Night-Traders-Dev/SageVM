...
static SageValue sage_method_SGVMUtils_trim(SageValue _self, int _argc, SageValue* _argv) {
    SageSlot sage_local_eidx_210 = sage_slot_undefined();
    ...
    SageSlot* sage_gc_roots[4] = {&sage_local_eidx_210, &sage_local_start_209, &sage_local_s_208, &sage_local_self_207};
    SageGcFrame sage_gc_frame;
    ...
    while (sage_truthy(sage_lt(sage_load_slot(&sage_local_start_209, "start"), sage_len(sage_load_slot(&sage_local_s_208, "s"))))) {
        if (sage_truthy(sage_lte(sage_ord(sage_index(sage_load_slot(&sage_local_s_208, "s"), sage_load_slot(&sage_local_start_209, "start"))), sage_number(32)))) {
    ...
    sage_define_slot(&sage_local_eidx_210, sage_len(sage_load_slot(&sage_local_s_208, "s")));
    while (sage_truthy(sage_gt(sage_load_slot(&sage_local_eidx_210, "eidx"), sage_load_slot(&sage_local_start_209, "start")))) {
        if (sage_truthy(sage_lte(sage_ord(sage_index(sage_load_slot(&sage_local_s_208, "s"), sage_sub(sage_load_slot(&sage_local_eidx_210, "eidx"), sage_number(1)))), sage_number(32)))) {
            (void)sage_assign_slot(&sage_local_eidx_210, "eidx", sage_sub(sage_load_slot(&sage_local_eidx_210, "eidx"), sage_number(1)));
        }
        else {
            break;
        }
    }
    return sage_gc_return(&sage_gc_frame, sage_call_method(sage_load_slot(&sage_local_self_207, "self"), "my_substr", 3, (SageValue[]){sage_load_slot(&sage_local_s_208, "s"), sage_load_slot(&sage_local_start_209, "start"), sage_sub(sage_load_slot(&sage_local_eidx_210, "eidx"), sage_load_slot(&sage_local_start_209, "start"))}));
    return sage_gc_return(&sage_gc_frame, sage_nil());
}

static SageValue sage_method_SGVMUtils_read_be16(SageValue _self, int _argc, SageValue* _argv) {
    SageSlot sage_local_off_213 = sage_slot_undefined();
    SageSlot sage_local_bs_212 = sage_slot_undefined();
    SageSlot sage_local_self_211 = sage_slot_undefined();
    SageSlot* sage_gc_roots[3] = {&sage_local_off_213, &sage_local_bs_212, &sage_local_self_211};
    SageGcFrame sage_gc_frame;
    sage_gc_push_frame(&sage_gc_frame, sage_gc_roots, 3);
    sage_define_slot(&sage_local_self_211, _self);
    sage_define_slot(&sage_local_bs_212, _argv[0]);
    sage_define_slot(&sage_local_off_213, _argv[1]);
    (void)_argc;
    return sage_gc_return(&sage_gc_frame, sage_add(sage_mul(sage_index(sage_load_slot(&sage_local_bs_212, "bs"), sage_load_slot(&sage_local_off_213, "off")), sage_number(256)), sage_index(sage_load_slot(&sage_local_bs_212, "bs"), sage_add(sage_load_slot(&sage_local_off_213, "off"), sage_number(1)))));
    return sage_gc_return(&sage_gc_frame, sage_nil());
}

static SageValue sage_method_SGVMUtils_read_be32(SageValue _self, int _argc, SageValue* _argv) {
    SageSlot sage_local_off_216 = sage_slot_undefined();
    SageSlot sage_local_bs_215 = sage_slot_undefined();
    SageSlot sage_local_self_214 = sage_slot_undefined();
    SageSlot* sage_gc_roots[3] = {&sage_local_off_216, &sage_local_bs_215, &sage_local_self_214};
    SageGcFrame sage_gc_frame;
    sage_gc_push_frame(&sage_gc_frame, sage_gc_roots, 3);
    sage_define_slot(&sage_local_self_214, _self);
    sage_define_slot(&sage_local_bs_215, _argv[0]);
    sage_define_slot(&sage_local_off_216, _argv[1]);
    (void)_argc;
    if (sage_truthy(sage_or(sage_or(sage_or(sage_neq(sage_type(sage_index(sage_load_slot(&sage_local_bs_215, "bs"), sage_load_slot(&sage_local_off_216, "off"))), sage_string("number")), sage_neq(sage_type(sage_index(sage_load_slot(&sage_local_bs_215, "bs"), sage_add(sage_load_slot(&sage_local_off_216, "off"), sage_number(1)))), sage_string("number"))), sage_neq(sage_type(sage_index(sage_load_slot(&sage_local_bs_215, "bs"), sage_add(sage_load_slot(&sage_local_off_216, "off"), sage_number(2)))), sage_string("number"))), sage_neq(sage_type(sage_index(sage_load_slot(&sage_local_bs_215, "bs"), sage_add(sage_load_slot(&sage_local_off_216, "off"), sage_number(3)))), sage_string("number"))))) {
        sage_print_ln(sage_add(sage_add(sage_add(sage_add(sage_add(sage_add(sage_add(sage_add(sage_add(sage_string("read_be32 error! off: "), sage_str(sage_load_slot(&sage_local_off_216, "off"))), sage_string(" types: ")), sage_str(sage_type(sage_index(sage_load_slot(&sage_local_bs_215, "bs"), sage_load_slot(&sage_local_off_216, "off"))))), sage_string(", ")), sage_str(sage_type(sage_index(sage_load_slot(&sage_local_bs_215, "bs"), sage_add(sage_load_slot(&sage_local_off_216, "off"), sage_number(1)))))), sage_string(", ")), sage_str(sage_type(sage_index(sage_load_slot(&sage_local_bs_215, "bs"), sage_add(sage_load_slot(&sage_local_off_216, "off"), sage_number(2)))))), sage_string(", ")), sage_str(sage_type(sage_index(sage_load_slot(&sage_local_bs_215, "bs"), sage_add(sage_load_slot(&sage_local_off_216, "off"), sage_number(3)))))));
    }
    return sage_gc_return(&sage_gc_frame, sage_add(sage_add(sage_add(sage_mul(sage_index(sage_load_slot(&sage_local_bs_215, "bs"), sage_load_slot(&sage_local_off_216, "off")), sage_number(16777216)), sage_mul(sage_index(sage_load_slot(&sage_local_bs_215, "bs"), sage_add(sage_load_slot(&sage_local_off_216, "off"), sage_number(1))), sage_number(65536))), sage_mul(sage_index(sage_load_slot(&sage_local_bs_215, "bs"), sage_add(sage_load_slot(&sage_local_off_216, "off"), sage_number(2))), sage_number(256))), sage_index(sage_load_slot(&sage_local_bs_215, "bs"), sage_add(sage_load_slot(&sage_local_off_216, "off"), sage_number(3)))));
    return sage_gc_return(&sage_gc_frame, sage_nil());
}

static SageValue sage_method_SGVMUtils_unpack_double(SageValue _self, int _argc, SageValue* _argv) {
    SageSlot sage_local_i_233 = sage_slot_undefined();
    SageSlot sage_local_e_232 = sage_slot_undefined();
    SageSlot sage_local_p2_231 = sage_slot_undefined();
    SageSlot sage_local_mantissa_230 = sage_slot_undefined();
    SageSlot sage_local_exp_229 = sage_slot_undefined();
    SageSlot sage_local_sign_228 = sage_slot_undefined();
    SageSlot sage_local_b7_227 = sage_slot_undefined();
    SageSlot sage_local_b6_226 = sage_slot_undefined();
    SageSlot sage_local_b5_225 = sage_slot_undefined();
    SageSlot sage_local_b4_224 = sage_slot_undefined();
    SageSlot sage_local_b3_223 = sage_slot_undefined();
    SageSlot sage_local_b2_222 = sage_slot_undefined();
    SageSlot sage_local_b1_221 = sage_slot_undefined();
    SageSlot sage_local_b0_220 = sage_slot_undefined();
    SageSlot sage_local_off_219 = sage_slot_undefined();
    SageSlot sage_local_bs_218 = sage_slot_undefined();
    SageSlot sage_local_self_217 = sage_slot_undefined();
    SageSlot* sage_gc_roots[17] = {&sage_local_i_233, &sage_local_e_232, &sage_local_p2_231, &sage_local_mantissa_230, &sage_local_exp_229, &sage_local_sign_228, &sage_local_b7_227, &sage_local_b6_226, &sage_local_b5_225, &sage_local_b4_224, &sage_local_b3_223, &sage_local_b2_222, &sage_local_b1_221, &sage_local_b0_220, &sage_local_off_219, &sage_local_bs_218, &sage_local_self_217};
    SageGcFrame sage_gc_frame;
    sage_gc_push_frame(&sage_gc_frame, sage_gc_roots, 17);
    sage_define_slot(&sage_local_self_217, _self);
    sage_define_slot(&sage_local_bs_218, _argv[0]);
    sage_define_slot(&sage_local_off_219, _argv[1]);
    (void)_argc;
    sage_define_slot(&sage_local_b0_220, sage_index(sage_load_slot(&sage_local_bs_218, "bs"), sage_load_slot(&sage_local_off_219, "off")));
    sage_define_slot(&sage_local_b1_221, sage_index(sage_load_slot(&sage_local_bs_218, "bs"), sage_add(sage_load_slot(&sage_local_off_219, "off"), sage_number(1))));
    sage_define_slot(&sage_local_b2_222, sage_index(sage_load_slot(&sage_local_bs_218, "bs"), sage_add(sage_load_slot(&sage_local_off_219, "off"), sage_number(2))));
    sage_define_slot(&sage_local_b3_223, sage_index(sage_load_slot(&sage_local_bs_218, "bs"), sage_add(sage_load_slot(&sage_local_off_219, "off"), sage_number(3))));
    sage_define_slot(&sage_local_b4_224, sage_index(sage_load_slot(&sage_local_bs_218, "bs"), sage_add(sage_load_slot(&sage_local_off_219, "off"), sage_number(4))));
    sage_define_slot(&sage_local_b5_225, sage_index(sage_load_slot(&sage_local_bs_218, "bs"), sage_add(sage_load_slot(&sage_local_off_219, "off"), sage_number(5))));
    sage_define_slot(&sage_local_b6_226, sage_index(sage_load_slot(&sage_local_bs_218, "bs"), sage_add(sage_load_slot(&sage_local_off_219, "off"), sage_number(6))));
    sage_define_slot(&sage_local_b7_227, sage_index(sage_load_slot(&sage_local_bs_218, "bs"), sage_add(sage_load_slot(&sage_local_off_219, "off"), sage_number(7))));
    sage_define_slot(&sage_local_sign_228, sage_number(1));
    if (sage_truthy(sage_eq(sage_call_method(sage_load_slot(&sage_local_self_217, "self"), "my_int", 1, (SageValue[]){sage_div(sage_load_slot(&sage_local_b0_220, "b0"), sage_number(128))}), sage_number(1)))) {
        (void)sage_assign_slot(&sage_local_sign_228, "sign", sage_sub(sage_number(0), sage_number(1)));
    }
    sage_define_slot(&sage_local_exp_229, sage_add(sage_mul(sage_call_method(sage_load_slot(&sage_local_self_217, "self"), "my_int", 1, (SageValue[]){sage_mod(sage_load_slot(&sage_local_b0_220, "b0"), sage_number(128))}), sage_number(16)), sage_call_method(sage_load_slot(&sage_local_self_217, "self"), "my_int", 1, (SageValue[]){sage_div(sage_load_slot(&sage_local_b1_221, "b1"), sage_number(16))})));
    sage_define_slot(&sage_local_mantissa_230, sage_number(1));
    if (sage_truthy(sage_eq(sage_load_slot(&sage_local_exp_229, "exp"), sage_number(0)))) {
        (void)sage_assign_slot(&sage_local_mantissa_230, "mantissa", sage_number(0));
        (void)sage_assign_slot(&sage_local_exp_229, "exp", sage_number(1));
    }
    (void)sage_assign_slot(&sage_local_mantissa_230, "mantissa", sage_add(sage_load_slot(&sage_local_mantissa_230, "mantissa"), sage_div(sage_call_method(sage_load_slot(&sage_local_self_217, "self"), "my_int", 1, (SageValue[]){sage_mod(sage_load_slot(&sage_local_b1_221, "b1"), sage_number(16))}), sage_number(16))));
    (void)sage_assign_slot(&sage_local_mantissa_230, "mantissa", sage_add(sage_load_slot(&sage_local_mantissa_230, "mantissa"), sage_div(sage_load_slot(&sage_local_b2_222, "b2"), sage_number(4096))));
    (void)sage_assign_slot(&sage_local_mantissa_230, "mantissa", sage_add(sage_load_slot(&sage_local_mantissa_230, "mantissa"), sage_div(sage_load_slot(&sage_local_b3_223, "b3"), sage_number(1048576))));
    (void)sage_assign_slot(&sage_local_mantissa_230, "mantissa", sage_add(sage_load_slot(&sage_local_mantissa_230, "mantissa"), sage_div(sage_load_slot(&sage_local_b4_224, "b4"), sage_number(268435456))));
    (void)sage_assign_slot(&sage_local_mantissa_230, "mantissa", sage_add(sage_load_slot(&sage_local_mantissa_230, "mantissa"), sage_div(sage_load_slot(&sage_local_b5_225, "b5"), sage_number(68719476736))));
    (void)sage_assign_slot(&sage_local_mantissa_230, "mantissa", sage_add(sage_load_slot(&sage_local_mantissa_230, "mantissa"), sage_div(sage_load_slot(&sage_local_b6_226, "b6"), sage_number(17592186044416))));
    (void)sage_assign_slot(&sage_local_mantissa_230, "mantissa", sage_add(sage_load_slot(&sage_local_mantissa_230, "mantissa"), sage_div(sage_load_slot(&sage_local_b7_227, "b7"), sage_number(4503599627370496))));
    sage_define_slot(&sage_local_p2_231, sage_number(1));
    sage_define_slot(&sage_local_e_232, sage_sub(sage_load_slot(&sage_local_exp_229, "exp"), sage_number(1023)));
    if (sage_truthy(sage_gt(sage_load_slot(&sage_local_e_232, "e"), sage_number(0)))) {
        sage_define_slot(&sage_local_i_233, sage_number(0));
        while (sage_truthy(sage_lt(sage_load_slot(&sage_local_i_233, "i"), sage_load_slot(&sage_local_e_232, "e")))) {
            (void)sage_assign_slot(&sage_local_p2_231, "p2", sage_mul(sage_load_slot(&sage_local_p2_231, "p2"), sage_number(2)));
            (void)sage_assign_slot(&sage_local_i_233, "i", sage_add(sage_load_slot(&sage_local_i_233, "i"), sage_number(1)));
        }
    }
    else {
        if (sage_truthy(sage_lt(sage_load_slot(&sage_local_e_232, "e"), sage_number(0)))) {
            sage_define_slot(&sage_local_i_233, sage_number(0));
            while (sage_truthy(sage_lt(sage_load_slot(&sage_local_i_233, "i"), sage_sub(sage_number(0), sage_load_slot(&sage_local_e_232, "e"))))) {
                (void)sage_assign_slot(&sage_local_p2_231, "p2", sage_div(sage_load_slot(&sage_local_p2_231, "p2"), sage_number(2)));
                (void)sage_assign_slot(&sage_local_i_233, "i", sage_add(sage_load_slot(&sage_local_i_233, "i"), sage_number(1)));
            }
        }
    }
    return sage_gc_return(&sage_gc_frame, sage_mul(sage_mul(sage_load_slot(&sage_local_sign_228, "sign"), sage_load_slot(&sage_local_mantissa_230, "mantissa")), sage_load_slot(&sage_local_p2_231, "p2")));
    return sage_gc_return(&sage_gc_frame, sage_nil());
}

static SageValue sage_method__Io_readfile(SageValue _self, int _argc, SageValue* _argv) {
    SageSlot sage_local_p_235 = sage_slot_undefined();
    SageSlot sage_local_self_234 = sage_slot_undefined();
    SageSlot* sage_gc_roots[2] = {&sage_local_p_235, &sage_local_self_234};
    SageGcFrame sage_gc_frame;
    sage_gc_push_frame(&sage_gc_frame, sage_gc_roots, 2);
    sage_define_slot(&sage_local_self_234, _self);
    sage_define_slot(&sage_local_p_235, _argv[0]);
    (void)_argc;
    return sage_gc_return(&sage_gc_frame, sage_io_readfile(sage_load_slot(&sage_local_p_235, "p")));
    return sage_gc_return(&sage_gc_frame, sage_nil());
}

static SageValue sage_method__Io_writefile(SageValue _self, int _argc, SageValue* _argv) {
    SageSlot sage_local_c_238 = sage_slot_undefined();
    SageSlot sage_local_p_237 = sage_slot_undefined();
    SageSlot sage_local_self_236 = sage_slot_undefined();
    SageSlot* sage_gc_roots[3] = {&sage_local_c_238, &sage_local_p_237, &sage_local_self_236};
    SageGcFrame sage_gc_frame;
    sage_gc_push_frame(&sage_gc_frame, sage_gc_roots, 3);
    sage_define_slot(&sage_local_self_236, _self);
    sage_define_slot(&sage_local_p_237, _argv[0]);
    sage_define_slot(&sage_local_c_238, _argv[1]);
    (void)_argc;
    return sage_gc_return(&sage_gc_frame, sage_io_writefile(sage_load_slot(&sage_local_p_237, "p"), sage_load_slot(&sage_local_c_238, "c")));
    return sage_gc_return(&sage_gc_frame, sage_nil());
}

static SageValue sage_method__Io_writebytes(SageValue _self, int _argc, SageValue* _argv) {
    SageSlot sage_local_b_241 = sage_slot_undefined();
    SageSlot sage_local_p_240 = sage_slot_undefined();
    SageSlot sage_local_self_239 = sage_slot_undefined();
    SageSlot* sage_gc_roots[3] = {&sage_local_b_241, &sage_local_p_240, &sage_local_self_239};
    SageGcFrame sage_gc_frame;
    sage_gc_push_frame(&sage_gc_frame, sage_gc_roots, 3);
    sage_define_slot(&sage_local_self_239, _self);
    sage_define_slot(&sage_local_p_240, _argv[0]);
    sage_define_slot(&sage_local_b_241, _argv[1]);
    (void)_argc;
    return sage_gc_return(&sage_gc_frame, sage_io_writebytes(sage_load_slot(&sage_local_p_240, "p"), sage_load_slot(&sage_local_b_241, "b")));
    return sage_gc_return(&sage_gc_frame, sage_nil());
}

static SageValue sage_method__Io_readbytes(SageValue _self, int _argc, SageValue* _argv) {
    SageSlot sage_local_p_243 = sage_slot_undefined();
    SageSlot sage_local_self_242 = sage_slot_undefined();
    SageSlot* sage_gc_roots[2] = {&sage_local_p_243, &sage_local_self_242};
    SageGcFrame sage_gc_frame;
    sage_gc_push_frame(&sage_gc_frame, sage_gc_roots, 2);
    sage_define_slot(&sage_local_self_242, _self);
    sage_define_slot(&sage_local_p_243, _argv[0]);
    (void)_argc;
    return sage_gc_return(&sage_gc_frame, sage_io_readbytes(sage_load_slot(&sage_local_p_243, "p")));
    return sage_gc_return(&sage_gc_frame, sage_nil());
}

static SageValue sage_method__Io_exists(SageValue _self, int _argc, SageValue* _argv) {
    SageSlot sage_local_p_245 = sage_slot_undefined();
    SageSlot sage_local_self_244 = sage_slot_undefined();
    SageSlot* sage_gc_roots[2] = {&sage_local_p_245, &sage_local_self_244};
    SageGcFrame sage_gc_frame;
    sage_gc_push_frame(&sage_gc_frame, sage_gc_roots, 2);
    sage_define_slot(&sage_local_self_244, _self);
    sage_define_slot(&sage_local_p_245, _argv[0]);
    (void)_argc;
    return sage_gc_return(&sage_gc_frame, sage_io_exists(sage_load_slot(&sage_local_p_245, "p")));
    return sage_gc_return(&sage_gc_frame, sage_nil());
}

static SageValue sage_fn_main_68() {
    SageSlot sage_local_compiler_252 = sage_slot_undefined();
    SageSlot sage_local_a_251 = sage_slot_undefined();
    SageSlot sage_local_i_250 = sage_slot_undefined();
    SageSlot sage_local_use_shebang_249 = sage_slot_undefined();
    SageSlot sage_local_output_file_248 = sage_slot_undefined();
    SageSlot sage_local_input_file_247 = sage_slot_undefined();
    SageSlot sage_local_args_246 = sage_slot_undefined();
    SageSlot* sage_gc_roots[7] = {&sage_local_compiler_252, &sage_local_a_251, &sage_local_i_250, &sage_local_use_shebang_249, &sage_local_output_file_248, &sage_local_input_file_247, &sage_local_args_246};
    SageGcFrame sage_gc_frame;
    sage_gc_push_frame(&sage_gc_frame, sage_gc_roots, 7);
    sage_define_slot(&sage_local_args_246, sage_native_sys_args());
    sage_define_slot(&sage_local_input_file_247, sage_string(""));
    sage_define_slot(&sage_local_output_file_248, sage_string(""));
    sage_define_slot(&sage_local_use_shebang_249, sage_bool(0));
    sage_define_slot(&sage_local_i_250, sage_number(0));
    while (sage_truthy(sage_lt(sage_load_slot(&sage_local_i_250, "i"), sage_len(sage_load_slot(&sage_local_args_246, "args"))))) {
        sage_define_slot(&sage_local_a_251, sage_index(sage_load_slot(&sage_local_args_246, "args"), sage_load_slot(&sage_local_i_250, "i")));
        if (sage_truthy(sage_endswith(sage_load_slot(&sage_local_a_251, "a"), sage_string(".sage")))) {
            (void)sage_assign_slot(&sage_local_input_file_247, "input_file", sage_load_slot(&sage_local_a_251, "a"));
        }
        else {
            if (sage_truthy(sage_endswith(sage_load_slot(&sage_local_a_251, "a"), sage_string(".sgvm")))) {
                (void)sage_assign_slot(&sage_local_output_file_248, "output_file", sage_load_slot(&sage_local_a_251, "a"));
            }
            else {
                if (sage_truthy(sage_eq(sage_load_slot(&sage_local_a_251, "a"), sage_string("--shebang")))) {
                    (void)sage_assign_slot(&sage_local_use_shebang_249, "use_shebang", sage_bool(1));
                }
            }
        }
        (void)sage_assign_slot(&sage_local_i_250, "i", sage_add(sage_load_slot(&sage_local_i_250, "i"), sage_number(1)));
    }
    if (sage_truthy(sage_or(sage_eq(sage_load_slot(&sage_local_input_file_247, "input_file"), sage_string("")), sage_eq(sage_load_slot(&sage_local_output_file_248, "output_file"), sage_string(""))))) {
        sage_print_ln(sage_string("Usage: sgvmc <input.sage> <output.sgvm> [--shebang]"));
        return sage_gc_return(&sage_gc_frame, sage_nil());
    }
    sage_define_slot(&sage_local_compiler_252, sage_construct("SGVMCompiler", NULL, 0, (SageValue[]){sage_nil()}));
    (void)sage_call_method(sage_load_slot(&sage_local_compiler_252, "compiler"), "compile", 3, (SageValue[]){sage_load_slot(&sage_local_input_file_247, "input_file"), sage_load_slot(&sage_local_output_file_248, "output_file"), sage_load_slot(&sage_local_use_shebang_249, "use_shebang")});
