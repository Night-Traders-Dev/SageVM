...
class SRVMRunner:
    ...
    proc run_file(self, input_file, debug=false, safe_mode=false, ffi_enabled=true, jit_enabled=false, exec_enabled=true):
        if debug:
        ...
        self.vm.state.exec_enabled = exec_enabled
        self.vm.state.jit_enabled = jit_enabled
