    ...
    proc run(self, code):
        ...
        while not halted and ip < code_len:
            ...
            if op == OP_GET_LOCAL:
                ...
                # Performance: non-allocating fast-path for numerical operands (bypasses standard type() heap string allocations)
                ...
                # Performance: non-allocating fast-path for numerical operands (bypasses standard type() heap string allocations)
                if a != nil and b != nil and tonumber(a) == a and tonumber(b) == b: stack[stack_len-1] = a < b
                ...
                if a != nil and b != nil and tonumber(a) == a and tonumber(b) == b:
                    ...
                    let type_a = type(a)
                    let type_b = type(b)
                    if type_a == "string" and type_b == "number":
