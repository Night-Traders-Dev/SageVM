    ...
    proc run(self, code):
        ...
        while not halted and ip < code_len:
            ...
            if op == OP_GET_LOCAL:
                ...
                # Performance: Fast-path bypass for common numerical operands to avoid C-level type() string allocation
                ...
                if a != nil and b != nil and tonumber(a) == a and tonumber(b) == b:
                    stack[stack_len-1] = a < b
                elif type(a) == "number" and type(b) == "number": stack[stack_len-1] = a < b
                ...
                if a != nil and b != nil and tonumber(a) == a and tonumber(b) == b:
                    if b != 0:
                        ...
                        stack[stack_len-1] = nil
                elif type(a) == "number" and type(b) == "number" and b != 0:
                    stack[stack_len-1] = a / b
                else:
                    stack[stack_len-1] = nil
            elif op == OP_SUB:
