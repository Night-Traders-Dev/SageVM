...
let OP_FALSE          = 3.0
let OP_POP            = 4.0
let OP_GET_GLOBAL     = 5.0
let OP_DEFINE_GLOBAL  = 6.0
let OP_SET_GLOBAL     = 7.0
let OP_DEFINE_FUNCTION = 8.0
let OP_GET_PROPERTY   = 9.0
let OP_SET_PROPERTY   = 10.0
let OP_GET_INDEX      = 11.0
let OP_SET_INDEX      = 12.0
let OP_LOAD_FUNCTION  = 13.0
let OP_SLICE          = 14.0
let OP_ADD            = 15.0
let OP_SUB            = 16.0
let OP_MUL            = 17.0
...
let OP_NEGATE         = 20.0
let OP_EQUAL          = 21.0
let OP_NOT_EQUAL      = 22.0
let OP_GREATER        = 23.0
let OP_GREATER_EQUAL  = 24.0
let OP_LESS           = 25.0
let OP_LESS_EQUAL     = 26.0
let OP_BIT_AND        = 27.0
let OP_BIT_OR         = 28.0
let OP_BIT_XOR        = 29.0
let OP_BIT_NOT        = 30.0
let OP_SHIFT_LEFT     = 31.0
let OP_SHIFT_RIGHT    = 32.0
let OP_NOT            = 33.0
let OP_TRUTHY         = 34.0
let OP_JUMP           = 35.0
let OP_JUMP_IF_FALSE  = 36.0
let OP_CALL           = 37.0
let OP_CALL_METHOD    = 38.0
let OP_ARRAY          = 39.0
let OP_TUPLE          = 40.0
let OP_DICT           = 41.0
let OP_PRINT          = 42.0
let OP_EXEC_AST_STMT  = 43.0
let OP_RETURN         = 44.0
let OP_PUSH_ENV       = 45.0
let OP_POP_ENV        = 46.0
let OP_DUP            = 47.0
let OP_ARRAY_LEN      = 48.0
let OP_BREAK          = 49.0
let OP_CONTINUE       = 50.0
let OP_LOOP_BACK      = 51.0
let OP_IMPORT         = 52.0
let OP_CLASS          = 53.0
let OP_METHOD         = 54.0
let OP_INHERIT        = 55.0
let OP_SETUP_TRY      = 56.0
let OP_END_TRY        = 57.0
let OP_RAISE          = 58.0

# GPU hot-path opcodes (Phase 16)
let OP_GPU_POLL_EVENTS         = 59.0
let OP_GPU_WINDOW_SHOULD_CLOSE = 60.0
let OP_GPU_GET_TIME            = 61.0
let OP_GPU_KEY_PRESSED         = 62.0
let OP_GPU_KEY_DOWN            = 63.0
let OP_GPU_MOUSE_POS           = 64.0
let OP_GPU_MOUSE_DELTA         = 65.0
let OP_GPU_UPDATE_INPUT        = 66.0
let OP_GPU_BEGIN_COMMANDS      = 67.0
let OP_GPU_END_COMMANDS        = 68.0
let OP_GPU_CMD_BEGIN_RP        = 69.0
let OP_GPU_CMD_END_RP          = 70.0
let OP_GPU_CMD_DRAW            = 71.0
let OP_GPU_CMD_BIND_GP         = 72.0
let OP_GPU_CMD_BIND_DS         = 73.0
let OP_GPU_CMD_SET_VP          = 74.0
let OP_GPU_CMD_SET_SC          = 75.0
let OP_GPU_CMD_BIND_VB         = 76.0
let OP_GPU_CMD_BIND_IB         = 77.0
let OP_GPU_CMD_DRAW_IDX        = 78.0
let OP_GPU_SUBMIT_SYNC         = 79.0
let OP_GPU_ACQUIRE_IMG         = 80.0
let OP_GPU_PRESENT             = 81.0
let OP_GPU_WAIT_FENCE          = 82.0
let OP_GPU_RESET_FENCE         = 83.0
let OP_GPU_UPDATE_UNIFORM      = 84.0
let OP_GPU_CMD_PUSH_CONST      = 85.0
let OP_GPU_CMD_DISPATCH         = 86.0
